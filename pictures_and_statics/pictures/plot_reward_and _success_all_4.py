...
reward_files.append(['4_maddpg_ncbf_reward1.csv',
                     '4_maddpg_ncbf_reward2.csv',
                     '4_maddpg_ncbf_reward3.csv'])
reward_files.append(['4_maddpg_cost_reward1.csv',
                     '4_maddpg_cost_reward2.csv',
                     '4_maddpg_cost_reward3.csv'])
reward_files.append(['4_maddpg_noreach_reward1.csv',
                     '4_maddpg_noreach_reward2.csv',
                     '4_maddpg_noreach_reward3.csv'])
reward_files.append(['4_maddpg_nocbf_reward1.csv',
                     '4_maddpg_nocbf_reward2.csv',
                     '4_maddpg_nocbf_reward3.csv'])
reward_files.append(['4_maddpg_cbq_reward1.csv',
                     '4_maddpg_cbq_reward2.csv',
                     '4_maddpg_cbq_reward3.csv'])
reward_files.append(['4_maddpg_abq_reward1.csv',
                     '4_maddpg_abq_reward2.csv',
                     '4_maddpg_abq_reward3.csv'])
rewards_all = []
...
total_steps = int(30000/50000*1000)
...
plt.savefig('4_all_rewards.pdf',dpi=1200,format='pdf')
plt.savefig('4_all_rewards.png',dpi=400,format='png')
plt.savefig('4_all_rewards.svg',dpi=400,format='svg')
