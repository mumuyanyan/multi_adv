...
reward_files.append(['maddpg_ncbf_reward1.csv','maddpg_ncbf_reward2.csv',
                     'maddpg_ncbf_reward3.csv'])
reward_files.append(['maddpg_cost_reward1.csv','maddpg_cost_reward2.csv',
                     'maddpg_cost_reward3.csv'])
reward_files.append(['maddpg_noreach_reward1.csv','maddpg_noreach_reward2.csv',
                     'maddpg_noreach_reward3.csv'])
reward_files.append(['maddpg_nocbf_reward1.csv','maddpg_nocbf_reward2.csv',
                     'maddpg_nocbf_reward3.csv'])
reward_files.append(['maddpg_cbq_reward1.csv','maddpg_cbq_reward2.csv',
                     'maddpg_cbq_reward3.csv'])
reward_files.append(['maddpg_abq_reward1.csv','maddpg_abq_reward2.csv',
...
for i in range(len(rewards_all_np)-1,-1,-1):
    ...
    # s_max = np.max(rewards_all_np[i], axis=1)
    # s_min = np.min(rewards_all_np[i], axis=1)
...
plt.savefig('all_rewards.pdf',dpi=1200,format='pdf')
plt.savefig('all_rewards.png',dpi=400,format='png')
plt.savefig('all_rewards.svg',dpi=400,format='svg')
